...
gdi_capture_dll.CaptureWindow.argtype = [ctypes.wintypes.HWND, ctypes.POINTER(ctypes.c_long),
                                         ctypes.POINTER(ctypes.c_long), ctypes.POINTER(ctypes.POINTER(ctypes.c_uint8))]
...
class CaptureWindow:
    ...
    def __enter__(self):
        ...
        self.bitmap_handle = gdi_capture_dll.CaptureWindow(self.hwnd, ctypes.byref(width), ctypes.byref(height),
